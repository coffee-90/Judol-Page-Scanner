...
############################################################################
# Costumized by: M.Jazuly						   #
# LinkedIn: https://www.linkedin.com/in/mjazuly/			   #
# Github: https://github.com/coffee-90					   #
############################################################################
...
## Judol pages
judol1="gacor"
##judol1="gacor | zeus | maxwin | zeusslot777 | slot88 | slot%20deposit"
judol2="zeus"
judol3="maxwin"
judol4="slot%20deposit"
##judol5="slot88"
##judolpagearray=($judol1 $judol2 $judol3 $judol4 $judol5)
judolpagearray=($judol1)
...
echo -e "$ORANGE║\t\t\t\t\t\t\t\t\t    ║$CLEAR_FONT";
echo -e "$ORANGE║$CLEAR_FONT$GREEN_BOLD\t\t\t    Judol Page Scan \t\t\t    $CLEAR_FONT$ORANGE║$CLEAR_FONT";
echo -e "$ORANGE║\t\t\t\t\t\t\t\t\t    ║\e[00m";
echo -e "$ORANGE╚═══════════════════════════════════════════════════════════════════════════╝$CLEAR_FONT";
echo -e "";
...
# Exploit
echo -e "$GREEN_BOLD[ * ] Checking Judol Page:$CLEAR_FONT"; PrintTheResults "${judolpagearray[@]}" | tee -a $folder/$filename;
